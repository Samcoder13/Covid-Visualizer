...
function displayBar(data) {     //map.js   , data-->selected fips value
    selected_state = null;
    selected_fips = data;
    ...
    $("#barchart").empty();
      ...
      var bartip = d3.tip()
        ...
        .offset([-5, 0])
        .html(function(d, i) {
          return "Date: " + sliced_data[i] //2021-10-1 se leke 2021-12-31 dates -->sliced data
